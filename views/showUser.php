<?php
	require_once "../controllers/control_user.php";
...
<html>
				...
				if($row_num > 0)
				{
					while($row = mysqli_fetch_assoc($run)): ?>
						<tr>
							...
							<td><a href="showUser.php?edit=<?php echo $row['userId']; ?>"><button>Edit</button></a></td>
							<td><a href="../controllers/control_user.php?delete=<?php echo $row['userId']; ?>"><button>Delete</button></a></td>
						</tr>
	...
	<form action="../controllers/control_user.php" method="POST">
            <table>
                <tr>
                    <td>Id:</td>
